...
$LAB.setOptions({
	AlwaysPreserveOrder : true
		...
		baseUrl + "js/bootstrap.min.js").wait().script(
		baseUrl + "js/jquery.sceditor.bbcode.min.js").wait().script(
		baseUrl + "js/jquery.sceditor.xhtml.min.js").wait().script(
		baseUrl + "js/select2.min.js").wait().script(
		baseUrl + "js/jsoneditor.min.js").wait().script(
		baseUrl + "js/promise.min.js").wait().script(
		...
		function() {
				...
				messageCallback : function(messageData) {
					...
					parent.send({
						...
						message : JSON.stringify(
								JSON.parse(messageData.message)).toString()
					});
			...
			$('#delete-form').click(
					function() {
						...
						var meta = {
							"absolute-url" : document.getElementById('iframe')
									.getAttribute('src'),
							"state" : data[0],
							"block" : data[2],
							"type" : data[4],
						...
						promise.post('/api/block', data).then(
