...
Core9.menu = {
		...
		menu : function(){
			...
			var menu = "";
			menu += '<ul id="context-menu" style="height: 80px;border:1px solid #000;position:absolute; top:{y}px; left:{x}px;background-color:#fff;width: 80px;color:#fff;z-index: 9999999;list-style: none;padding: 20px;">';
