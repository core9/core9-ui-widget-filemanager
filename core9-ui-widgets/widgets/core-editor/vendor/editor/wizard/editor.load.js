...
$LAB
		...
		.script(baseUrl + "vendor/editor/assets/js/jquery.js")
		.script(baseUrl + "vendor/editor/assets/js/bootstrap.min.js")
		.script(baseUrl + "vendor/editor/assets/js/jquery.sceditor.bbcode.min.js")
		.script(baseUrl + "vendor/editor/assets/js/jquery.sceditor.xhtml.min.js")
		.script(baseUrl + "vendor/editor/assets/js/select2.min.js")
		.script(baseUrl + "vendor/editor/assets/js/jsoneditor.min.js")
		.script(baseUrl + "vendor/editor/assets/js/promise.min.js")
		.script(baseUrl + "vendor/editor/assets/js/iframeResizer.min.js")
		.script(baseUrl + "vendor/editor/assets/js/wizard-engine.js")
		.script(baseUrl + "vendor/editor/assets/js/editor.load.css.js")
		.wait(
				function() {
